...
export declare namespace SorobanRpc {
    ...
    export function isSimulationRaw(sim: SorobanRpc.SimulateTransactionResponse | SorobanRpc.RawSimulateTransactionResponse): sim is SorobanRpc.RawSimulateTransactionResponse;
