...
export declare class Server {
    ...
    _getLedgerEntries(...keys: xdr.LedgerKey[]): Promise<SorobanRpc.RawGetLedgerEntriesResponse>;
    /**
    ...
    _getTransaction(hash: string): Promise<SorobanRpc.RawGetTransactionResponse>;
    /**
    ...
    _getEvents(request: Server.GetEventsRequest): Promise<SorobanRpc.RawGetEventsResponse>;
    /**
    ...
    _simulateTransaction(transaction: Transaction | FeeBumpTransaction): Promise<SorobanRpc.RawSimulateTransactionResponse>;
    /**
    ...
    _sendTransaction(transaction: Transaction | FeeBumpTransaction): Promise<SorobanRpc.RawSendTransactionResponse>;
    /**
